          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-2 max-w-xs">
              <input
                ...
                className="flex-1 h-9 rounded-lg border border-border bg-muted/30 px-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/40"
              />
