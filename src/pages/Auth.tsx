...
const Auth = () => {
  ...
  const afterAuthRedirect = useCallback(async () => {
    ...
    if (BILLING_ENABLED && pendingPlan && ["starter", "growth", "enterprise"].includes(pendingPlan)) {
      try {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center pt-16 px-6">
        ...
        >
          ...
          {view !== "forgot-password" && view !== "reset-password" && (capabilities.auth.google || capabilities.auth.github) && (
            <>
              <div className="flex gap-3 mb-6">
                <Button
                  ...
                  hidden={!capabilities.auth.google}
                  type="button"
                >
                ...
                <Button
                  ...
                  hidden={!capabilities.auth.github}
                  type="button"
                >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {view !== "reset-password" && <div className="space-y-2">
