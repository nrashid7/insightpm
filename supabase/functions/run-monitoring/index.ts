...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`Processing ${dueProducts.length} products for monitoring`);
    ...
    console.log(`Monitoring complete: ${results.length} products, ${totalAlerts} alerts`);
    ...
    console.error("run-monitoring error:", e);
    return new Response(
